...
/** Pure-JS SHA-256 (FIPS 180-4), exported for the equivalence test against Web Crypto. */
export function sha256Sync(bytes: Uint8Array): Uint8Array {
  // Pre-processing: append 0x80, pad with zeros to 56 mod 64, append the bit length big-endian.
