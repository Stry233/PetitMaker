...
export type Evidence = { source: 'obscenity' | 'two-toad' | 'naughty-words' | 'coffee-and-fun' | 'zhin-homophone' | 'konsheng-explicit' | 'konsheng-violence' | 'konsheng-solicitation' | 'konsheng-supplement' | 'konsheng-omnibus' | 'konsheng-rule' | 'owner-content'; category?: never }
  | { source: 'zhin-political' | 'fwwdn-political' | 'houbb-political' | 'konsheng-numeric' | 'konsheng-political' | 'owner-political'; category: 'political' };
