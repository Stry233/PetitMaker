...
const KEYS = [
  ...
  'export.btn_export','export.btn_cancel','export.exporting','export.map_summary',
  ...
  'export.code_label','export.code_too_small',
  'export.appearance',
  'export.preview_hint',
  ...
  'export.footer_fill','export.footer_fill_hint','export.footer_insert','export.footer_ph','export.footer_slash_hint','export.footer_help','export.badge_help','export.badge_why',
