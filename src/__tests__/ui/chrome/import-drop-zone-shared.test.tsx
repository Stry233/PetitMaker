...
vi.mock('../../../ui/chrome/modals/import/ImportDropZone', async (importOriginal) => {
  ...
  const actual = await importOriginal<typeof import('../../../ui/chrome/modals/import/ImportDropZone')>();
  return {
    ...actual,
