 ...
 * whose mount effect synchronously builds the whole 2D renderer first — so a fetch started there
 * queues behind work that session was never going to show. Started from the entry point, it overlaps
