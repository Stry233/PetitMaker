...
export interface ToolContext {
   ...
   *
   * A tool answers the pointer from what it is handed. Reaching past this into the store made every
   * one of these a hidden argument: invisible in the signature, unmockable without seeding a global,
   * and free to differ between the probe that draws the cursor and the click that acts.
   */
