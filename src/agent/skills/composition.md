...
METHOD
1. Block the masses first: sculpt_terrace / paint_terrain for the primary form and its counterweights, off-center (2/3 vs 1/3 split), before any object.
2. view_map. Ask: is there one dominant form? Does the front/back axis read? Is anything stamped twice?
3. Fix masses (extend, shrink, demote one of two rivals) before detailing — mass edits are cheap now, expensive later.
4. Place buildings and roads against the settled masses: doors toward the open side, routes aimed at destinations.
