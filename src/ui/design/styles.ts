 ...
 * claims a layer nobody can find, and it is how this ladder rotted the first time: the number said
 * nothing about what it was meant to be over.
 *
 * ONE OFFSET IS STILL FAIR, and it is the only one: ordering two parts of ONE cluster against each
