...
// open popover on any outside click, plus a viewport clamp for positioning it. Used by HelpBubble
// and FooterEditor (both render a fixed-position popover anchored to a button/caret).
