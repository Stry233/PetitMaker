...
export function ImportModal() {
  ...
  return (
    <ModalShell open={open} onClose={() => close(false)} width={IMPORT_CARD_WIDTH} maxVwPct={92} cardStyle={{ padding: IMPORT_CARD_PADDING }} ariaLabel={t('import.title')}>
      <div style={{ ...modalTitle, marginBottom: 14 }}>{t('import.title')}</div>
      <ImportDropZone
        dragOver={dragOver}
        busy={busy}
        onClick={pickFile}
