...
import {
  colors, springs, exitTransition, radii, buttonMotion, modalTitle, footerGhost, footerPrimary,
} from '../../styles';
...
const cardStyle: CSSProperties = { padding: IMPORT_CARD_PADDING, position: 'relative', overflow: 'hidden' };
          ...
          {phase.kind === 'confirm' ? (
            ...
            >
              <div style={confirmPanel}>
                <div style={modalTitle}>{t('import.drop_replace_title', { name: phase.name })}</div>
