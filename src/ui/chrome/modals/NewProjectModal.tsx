...
import { font, inkTint, pressable, cursors, radii } from '../../design/styles';
import { ModalShell } from '../../primitives/ModalShell';
import { skin, windowCard, windowPrimary, windowTitle } from '../../design/window-skin';
...
const warnStyle: CSSProperties = {
  ...
  fontFamily: font.family, fontSize: 15, fontWeight: 800, color: skin.ink,
};
const exportBtnStyle: CSSProperties = {
  ...windowPrimary, flex: '0 0 auto', padding: '6px 14px', fontSize: 14, whiteSpace: 'nowrap',
};
