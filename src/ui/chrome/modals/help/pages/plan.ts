...
export const PLAN_PAGES: readonly HelpPage[] = [
  {
    ...
    sections: [
      { kind: 'prose', anchor: 'notes-zone', titleKey: 'help.notes.zone_t', bodyKeys: ['help.notes.zone_b1'] },
      { kind: 'prose', anchor: 'notes-textroute', titleKey: 'help.notes.textroute_t', bodyKeys: ['help.notes.textroute_b1'], figure: { kind: 'demo', scene: 'notetext' } },
      { kind: 'prose', anchor: 'notes-naming', titleKey: 'help.notes.naming_t', bodyKeys: ['help.notes.naming_b1'] },
      { kind: 'prose', anchor: 'notes-select', titleKey: 'help.notes.select_t', bodyKeys: ['help.notes.select_b1'] },
      { kind: 'prose', anchor: 'notes-manage', titleKey: 'help.notes.manage_t', bodyKeys: ['help.notes.manage_b1'] },
