...
import type { Restriction, ReviewProgress, ReviewResult, TextPart } from '../../../../../io/moderation/text/policy';
...
export function reviewReasonKey(reason: Restriction): string {
  if (reason === 'website') return 'export.review.website';
  return reason === 'political' ? 'export.review.political' : 'export.review.content';
}
