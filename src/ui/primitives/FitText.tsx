/*
 * FitText.tsx — a language-adaptive label. The panels are laid out at fixed
...
interface Props {
  ...
  color?: string;
  weight?: number;
  /** Optional outline (a white stroke around a label standing on the map) via textShadow. */
  outline?: string;
  style?: CSSProperties;
  children: ReactNode;
}
