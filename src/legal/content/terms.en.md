...
These Terms of Use govern your access to and use of {app}. The English and Chinese versions of these terms are intended to state the same obligations; if they ever appear to conflict, mandatory applicable law controls. {app} is an unofficial, fan-made tool and is not affiliated with, endorsed by, or sponsored by miHoYo / HoYoverse (COGNOSPHERE PTE. LTD.).
...
The following terms carry the meanings given here throughout this document:

- **"these terms"** means this Terms of Use document, as updated from time to time under [Article 21](#21-changes).
...
By using {app}, you accept these terms in full. If you do not agree to them, you must not use the tool.

You must be old enough to form a binding agreement in the place where you live, and you must otherwise have the legal capacity to accept these terms. If you are a minor in your jurisdiction, you may use {app} only with the involvement and consent of a parent or guardian, who accepts these terms on your behalf and is responsible for your use of the tool.
...
Acceptable use of {app} means using it lawfully and without harming the service or other persons. You agree that you will not:
...
## 6. User Content & Third-Party Material
...
Exporting or sharing an **importable** image makes the embedded map data **technically accessible** to anyone who has the image, who may then be able to reconstruct your map in {app}. This is a technical characteristic of the file; it is **not** a grant of any copyright license to recipients. You decide what you publish and where, and you should therefore share importable images only with people whom you are content to allow to open your map.

## 8. Availability, Updates & Discontinuation

{app} is provided **as is** and **as available**, with no commitment as to uptime or availability. We may change, suspend, add to, or remove features at any time, and the service may be **discontinued**. Whatever becomes of the service, the maps and files stored **locally** on your device remain on your device.

## 9. User Backup Responsibility

You are responsible for backing up your own work. Because your maps reside in your browser and in the files you export, you should **back up** anything you value by exporting map files or images. Browser data can be lost, whether through the browser, the device, an extension, or your own actions, including the use of Settings then Local data, and we cannot recover it for you.
...
{app} is a free tool offered at no charge. We limit our liability to the maximum extent permitted by applicable law: we will not be liable for any indirect, incidental, special, consequential, or punitive damages, nor for any loss of data, maps, or profits, arising out of or relating to your use of, or inability to use, the tool.

Nothing in these terms excludes or limits any liability that **cannot lawfully be excluded** or limited, such as liability for death or personal injury caused by negligence, or for fraud, where applicable law does not permit its exclusion.

## 12. Consumer-Law Savings Clause

If you use {app} as a consumer, the **mandatory consumer protections** of the country or region where you live are **unaffected** by these terms. Where any term conflicts with a mandatory consumer right, that mandatory right prevails, and the remainder of these terms continues to apply.

## 13. Intellectual-Property Complaints

If you believe that material in {app} infringes your intellectual-property rights, please contact us at {email} with the subject tag **[IP]**. So that we can act on your complaint, please include enough detail to identify the material and where it appears; the right you hold and the basis for it; your contact information; and a statement of your good-faith belief.

After we receive a complete complaint, we will acknowledge it, review it in good faith, and, where it is well-founded, act on it, including by removing or replacing the material. We will let you know the outcome of our review. If a complaint is unclear or incomplete, we may ask you for the further detail we need before we can act. Nothing in this procedure limits any legal remedy otherwise available to you.
...
These terms, together with the [Privacy Policy](/privacy) and any document they expressly incorporate, are the entire agreement between you and us concerning the free service, and they supersede any prior understanding on that subject. This does not exclude any liability or right that cannot lawfully be excluded, nor any mandatory protection preserved by [Article 11](#11-limitation-of-liability) or [Article 12](#12-consumer-law-savings-clause).

## 16. Severability

If any provision of these terms is held to be invalid, unlawful, or unenforceable, that provision is severed to the minimum extent necessary, and the remaining provisions continue in full force. Where possible, an invalid provision is read down so as to give the greatest lawful effect to its original intent.

## 17. No Waiver

If we do not enforce a provision of these terms, or delay in doing so, that is not a waiver of the provision or of our right to enforce it later. A waiver is effective only if we give it in writing, and it applies only to the specific instance and purpose for which it is given.

## 18. No Assignment & Succession

You may not assign or transfer your rights or obligations under these terms without our prior written consent. We may transfer our rights and obligations under these terms to a successor who takes over the operation of {app}, for example if the project's stewardship changes, provided that doing so does not reduce the rights the law grants you as a consumer.
...
Headings are for convenience only and do not affect interpretation. "Including" and "for example" introduce illustrations and do not limit what precedes them. A reference to a statute or law includes that law as it applies where you live and as it is amended over time.
